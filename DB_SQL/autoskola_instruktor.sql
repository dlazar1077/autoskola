...
CREATE TABLE `instruktor` (
  `INSTRUKTOR_ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `FK_INS_KOR_idx` (`KORISNIK_ID`),
  CONSTRAINT `FK_INS_KOR` FOREIGN KEY (`KORISNIK_ID`) REFERENCES `korisnik` (`KORISNIK_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
